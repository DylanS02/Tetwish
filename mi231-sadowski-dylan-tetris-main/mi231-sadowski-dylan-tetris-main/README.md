...
1. **What are the controls to your game? How do we play?**
	Use a and d to rotate the pice as it falls, and hold s to make it fall faster


<br>

2. **What creative additions did you make? How can we find them?**
	- Made The pieces fall smooother when holding s, instead of just being a singular input that makes 	them fall faster
	- Added a Main Menu and Game Over screen, with working buttons and a quit button, alongside 	background music whenever you wer at the menu screen
	- Made a soundeffect play whevener you cleared a line
	- Made the game load a "Game Over" screen instead of just ending


<br>

3. **Any assets used that you didn't create yourself?** <br> (art, music, etc. Just tell us where you got it, link it here)
	- Tetris Theme [DISTORTED]: https://youtu.be/RTwcXuGX8zY?si=2_Y484BG7pSaZK_a
	- "Yeah" Sound Effect: Soos Keyboard: https://youtu.be/ypfd1s4g5ac?si=124a67K64AbFpLiy
	- Sad trombone sound effect: https://youtu.be/CQeezCdF4mk?si=fc_TCI4AxfvCaajh
...
5. **Did you get help from any AI Code Assistants?** <br> (Tell us which .cs file to look in for the citation and describe what you learned)
	- ChatGPT with GameBoard and GameManager: It told me how to format the code, and I double checked it 	with ChatGPT to makesure it was right. Used it for the Gameboard audio section of the code, the Game 	Manager DROP_SECONDS part, and the Void Update Fall timer section. 
...
7. **What trouble did you have with this project?**
	Having a soundeffect play whenever a line was cleared. 
